...
@Gecco(matchUrl = "https://www.taobao.com/market/nvzhuang/index.php?spm={code}", pipelines = { "consolePipeline",
		"taoBaoPipeline" })
public class TaoBao implements HtmlBean {
	...
	public static void main(String[] args) {
		...
		GeccoEngine.create().classpath("com.flchy.blog.common.crawler")
				// 开始抓取的页面地址
