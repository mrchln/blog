...
public class WriteUtils {
	...
	private static String tmpPath = System.getProperty("java.io.tmpdir") + System.getProperty("file.separator") + "lockDir";
	...
	/**
	 * 线程安全的，不会出现串行 多个线程操作FileWriter或者BufferedWriter时，每一次写入操作都是可以保证原子性的，也即：
	 * FileWriter或者BufferedWriter是线程安全的
	 * 
	 * @param outFile
	 * @param conent
	 * @param wrap
